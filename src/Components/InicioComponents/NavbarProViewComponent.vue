<template>
  ...
  * {
  ...
  margin: 16px;
  width: calc(100% - 32px); /* Full width minus margins on mobile */
  }
  ...
  .location-selector-container {
    margin: 0;
    width: auto;
    max-width: 200px; /* Reduced width on desktop */
  }
  }
  ...
  He solucionado el problema de las sugerencias de búsqueda que estaban siendo tapadas por el menú de navegación. La solución principal fue aumentar el z-index de las sugerencias de búsqueda para asegurar que aparezcan por encima de todos los demás elementos:
