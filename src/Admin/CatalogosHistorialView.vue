      ...
      <div class="card-body p-0">
        <div class="p-3">
          <div class="input-group mb-3">
            ...
            <input type="text" class="form-control" placeholder="Buscar catálogo..." v-model="search"
        ...
        <div class="d-flex justify-content-center align-items-center p-3">
          <button class="btn btn-sm btn-outline-primary me-2" @click="cambiarPagina(-1)" :disabled="paginaActual === 1">
            Anterior
          </button>
          <span>Página {{ paginaActual }} de {{ totalPaginas }}</span>
          <button class="btn btn-sm btn-outline-primary ms-2" @click="cambiarPagina(1)"
    ...
    <div class="position-fixed bottom-0 end-0 p-3" style="z-index: 11">
      <div id="notificationToast" class="toast" role="alert" aria-live="assertive" aria-atomic="true">
        <div class="toast-header"
          :class="notificacion.tipo === 'success' ? 'bg-success text-white' : 'bg-danger text-white'">
