...
const maxDescriptionLength = ref(120); // Valor inicial que se ajustará según el tamaño de pantalla
...
// Verificar si es dispositivo móvil y ajustar valores según el tamaño de pantalla
const checkMobile = () => {
  const windowWidth = window.innerWidth;
  isMobile.value = windowWidth < 768;
  
  // Ajustar el tamaño máximo de descripción basado en tamaño de pantalla
  if (windowWidth < 480) {
    maxDescriptionLength.value = 60;
  } else if (windowWidth < 768) {
    maxDescriptionLength.value = 80;
  } else {
    maxDescriptionLength.value = 120;
  }
};
