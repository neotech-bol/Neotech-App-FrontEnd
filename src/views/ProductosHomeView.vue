...
/* View Mode Toggle - Optimizado para móviles */
.view-mode-toggle {
  display: flex;
...
/* Filters Section - Optimizado para móviles */
.filters-wrapper {
  position: sticky;
  top: 0;
  z-index: 100;
...
/* Advanced Filters - Optimizado para móviles */
.filters {
  display: flex;
  flex-direction: column;
  gap: 0.75rem;
...
/* Product Actions - Optimizado para móviles */
...
@media (hover: none) {
  ...
  .banner-cta {
    background: linear-gradient(to right, var(--primary-color, #3498db), #2980b9);
    animation: pulse 2s infinite;
  }
